...
public:
    int find_chor_police(string s[], int saitama){
        ...
        for (i = 1; i <= saitama; i++){
            ...
            mj4 = 0;
            easy++;
            cout<< endl<< "Round no: " << i << endl << endl;
            ...
            if(i % 2 == 1){
                ...
                while (1){
                    if(choose == ed || choose < 1 || choose > 4){
                        cout<< endl<< "You have chosen Invalid. Please guess again:" << endl;
                        cin>> choose;
                    }
                    else{
                        break;
...
int main(){
    ...
    string a[10], b[10];
    int n, number;
    cout<< endl<< "                  Welcome to the world of Chor Dakat Police Babu Game " << endl<< endl;
    ...
    cout<< "9. Therefore the game will be completed and will be completely shut down" << endl << endl;
    system("pause");
    system("cls");
    cout<< endl << endl;
    char choose;
    ...
    if (choose == '1'){
        ...
        cout<< "Continue the game at your own will" << endl<< endl;
        system("pause");
        system("cls");
    }
    ...
    cout<< endl<< "So how many times do you guys want to play: 8, 16 or 20?";
    cin >> number;
    system("cls");
    ...
    if (ans == 0)
    {
        while (1)
        {
            cout << endl<< endl << "The game has been restarted" << endl<< endl;
            system("pause");
            system("cls");
            cout << endl<< "Enter 4 player names:" << endl;
            for (int i = 1; i <= 4; i++){
                cout<< "Player no. " << i << ":";
                if (i == 1){
                    cin.ignore();
